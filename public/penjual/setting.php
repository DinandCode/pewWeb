        ...
        <div class="flex flex-col justify-between border-e bg-gray-50 w-64">
            <div class="px-4 py-6">
                ...
                <ul class="mt-6 space-y-1">
                    ...
                    <li>
                        <a href="setting.php" class="block rounded-lg bg-gray-100 px-4 py-2 text-sm font-medium text-gray-700">Pengaturan</a>
                    </li>
                    <li>
                        <form action="#">
                            <a href="/CafungE/public/login/login.php" type="submit" class="w-full rounded-lg px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-700">Logout</a>
                        </form>
                    </li>
                </ul>
            </div>
